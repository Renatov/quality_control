...
class MrpWorkOrderProduce(models.TransientModel):
    ...
    def default_get(self, cr, uid, var_fields, context=None):
        ...
        work = self.pool['mrp.workorder'].browse(
    ...
    def _get_product_id(self):
        ...
        if self.env.context.get("active_id"):
            work_line = self.env['mrp.workorder'].browse(
    ...
    def do_produce(self, cr, uid, ids, context=None):
        work_line = self.pool['mrp.workorder'].browse(
    ...
    consume_lines = fields.One2many('mrp.product.produce',
                                    'work_produce_id',
